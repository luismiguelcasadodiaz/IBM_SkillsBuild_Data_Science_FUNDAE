...
app.layout = html.Div(children=[ html.H1(children="Flight Delay Time Statistics", style={'text-align':'center', 'color':'#503D36', 'font-size':'30'}),
                                html.Div(["Input Year: ", 
                                ...
                                html.Div( dcc.Graph(id='late-plot'), style={'width':'95%'})
                                ])
